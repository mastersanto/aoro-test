...
5. Launch the `constitution-check` agent on the drafted spec.md and include its verdict when presenting the spec.
6. Remind the user the spec needs their approval before `/plan-feature`.
